...
Game2048.prototype._renderBoard = function () {
  //for each row , consolelog the row
...
$(document).ready(function(){
  ...
  function renderTiles () {
    // console.log("rowout "+row, "rowoutIndex "+rowIndex);

  game.board.forEach(function(row, rowIndex){
    console.log("row "+row, "rowIndex "+rowIndex);
    row.forEach(function (cell, cellIndex) {
      console.log("cel "+cell, "celIndex "+cellIndex);

      if (cell) {//this line if (cell) tells if there is some value in the current cell
...
//convert node collection into an array
